...
function containerCalculate (maxWeight, weightIncluded, id, weightNextContainer, ignoredContainers ) {
  ...
  if (id <= 100) {
      ...
      if (id >= 61 && id <= 70) {
        id++;
        ignoredContainers++;
        // continue; // oder: containerCalculate (maxWeight, weightIncluded, id, weightNextContainer, ignoredContainer )
      }
  ...
  if (maxWeight >= weightIncluded + weightNextContainer) {
    containerCalculate(maxWeight, weightIncluded, id, weightNextContainer. ignoredContainer);
